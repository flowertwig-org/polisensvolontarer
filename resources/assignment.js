(function () {
    ...
    result.then(function (response) {
        ...
        if ('content' in document.createElement('template')) {
            ...
            assignmentWhenAndWhere.innerHTML = "<a href='https://www.google.se/maps/search/" + encodeURI(assignment.meetupPlace + ', sweden') + "'>" + assignment.meetupPlace + "</a> den " + assignment.meetupTime + ".";
